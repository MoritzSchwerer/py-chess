...
PastGameState::PastGameState(const GameState &state)
    : w_pawn(state.w_pawn), w_rook(state.w_rook), w_knight(state.w_knight),
      w_bishop(state.w_bishop), w_queen(state.w_queen), w_king(state.w_king),
      b_pawn(state.b_pawn), b_rook(state.b_rook), b_knight(state.b_knight),
      b_bishop(state.b_bishop), b_queen(state.b_queen), b_king(state.b_king),
